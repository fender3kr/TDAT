...
### Installation
* Download the project at https://github.ncsu.edu/stac/TDAT
...
![](https://github.ncsu.edu/stac/useful-material/blob/master/images/Load.png)
...
![](https://github.ncsu.edu/stac/useful-material/blob/master/images/Label.png)
...
![](https://github.ncsu.edu/stac/useful-material/blob/master/images/Fit.png)

* To select an object, click the second button in the toolbar:
![](https://github.ncsu.edu/stac/useful-material/blob/master/images/Select.png)

* Then, draw a rectangle on the desired object in the canvas, select a label to give, and click "Add Annotation" button:
![](https://github.ncsu.edu/stac/useful-material/blob/master/images/AddAnnotation.png)
